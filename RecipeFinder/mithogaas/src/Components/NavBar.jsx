...
const NavBar = ({ theme, toggleTheme }) => {
    return(
     <nav className="flex items-center justify-between px-6 py-4 shadow">
        ...
        <Link to="/recipes" className="px-4 py-2 text-gray-900 hover:text-[#58e633] font-semibold transition-colors font-share">Recipes</Link>

        <Link to="/favorites" className="px-4 py-2 text-gray-900 hover:text-[#58e633] font-semibold transition-colors font-share">Favorites</Link>
